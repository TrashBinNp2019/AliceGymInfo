...
def handle_dialog(req, res):
    ...
    if req['session']['new']:
        ...
        res['response']['text'] = "Здравствуйте. Я - голосовой помощник для учеников и гостей Гимназии № 2 г. Новополоцка, и я могу отвечать на ваши вопросы о ней, просто спросите. Чем могу быть полезна?"
        res['response']['tts'] = "Здравствуйте. Я - голосовой помощник для учеников и гостей Гимназии № 2 г. Новополоцка, и я могу отвечать на ваши вопросы о ней, просто спросите. Чем могу быть полезна?"
